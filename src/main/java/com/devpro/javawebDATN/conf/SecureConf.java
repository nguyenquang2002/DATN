...
import com.devpro.javawebDATN.services.UserDetailsServiceImpl;
...
//		.defaultSuccessUrl("/", true) // login thành công thì luôn trở về trang người dùng
	...
	public static void main(String[] args) {
		System.out.println(new BCryptPasswordEncoder(4).encode("employee"));
	}

	...
	<div class="container-fluid">
	  <div class="row">
	    ...
	    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
			...
			<sf:form method="post" action="${base}/admin/product/gear" modelAttribute="gear" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="form-group mb-2 col-12">
						<label for="loaiLaptop">Loại gear:</label>
						<sf:select path="loaiGear.id" class="form-control" id="trangThai">
							<sf:options items="${loaiGears }" itemValue="id" itemLabel="loaiGear"/>
						</sf:select>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="form-group">
						<img alt="" style="width: 100px; height: 100px;" src="${base }/upload/${gear.sanPham.avatar}">
					</div>
				</div>

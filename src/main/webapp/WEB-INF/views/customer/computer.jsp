            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="page-title-wrap">
                        <div class="page-title-heading"><h1 class="h2">PC<span>Desktop</span></h1></div>
                        <ul class="list-unstyled mb-0">
                            <li><a href="${base}/index">Trang chủ</a></li>
                            <li><a href="${base}/list">Sản phẩm</a></li>
                            <li class="active"><a>${pc.sanPham.tenSanPham }</a></li>
                        </ul>
                    </div>
                        ...
                        <!-- Start shop slider top side -->
                         <div class="swiper-container product-gallery">
                            <div class="swiper-wrapper">
                            	...
                            	<c:forEach items="${pc.sanPham.hinhAnhSanPhams }" var="hinhAnh">
                    ...
                    <div class="product-details-inner">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-title">
                                <h2><a>${pc.sanPham.tenSanPham }</a></h2>
                            </div>
                            <!-- end of product title -->

                             <div class="product-price">
                             	<h3 class="new-price">${pc.sanPham.giaBanFormatted }</h3>
                             	<c:if test="${pc.sanPham.giamGia > 0 }">
                             		<h5 class="old-price">${pc.sanPham.giaTienFormatted }</h5>
                             	</c:if>
                             </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td class="hardware">${main.sanPham.tenSanPham }</td>
                                        <td>1</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">CPU</th>
                                        <td class="hardware">${cpu.sanPham.tenSanPham }</td>
                                        <td>1</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">RAM</th>
                                        <td class="hardware">${ram.sanPham.tenSanPham }</td>
                                        <td>${slRam }</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">VGA</th>
                                        <td class="hardware">${vga.sanPham.tenSanPham }</td>
                                        <td>1</td>
                                      </tr>
                                      
                                      <tr>
                                        <th scope="row">SSD</th>
                                        <td class="hardware">${harddrive.sanPham.tenSanPham }</td>
                                        <td>1</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">PSU</th>
                                        <td class="hardware">${psu.sanPham.tenSanPham }</td>
                                        <td>1</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">FAN</th>
                                        <td class="hardware">${fan.sanPham.tenSanPham }</td>
                                        <td>1</td>
                                      </tr>
                                      <tr>
                                        <th scope="row">CASE</th>
                                        <td class="hardware">${casePC.sanPham.tenSanPham }</td>
                                        <td>1</td>
                                      </tr>
                                    </tbody>
                                  </table>
                                ...
                                <ul class="mb-0 list-unstyled">
                                    ...
                                    <li class="available-group group">
                                        ...
                                        <div class="product-available">
                                            <input type="text" value="${pc.sanPham.soLuong }" class="product-quantity-list product-size">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="product-details-btns">
                                <div class="addto-bag-btn">
                                    <div onclick="AddToCart('${base}',${pc.sanPham.id },parseInt(document.getElementById('quantityInput').value))">
                                    ...
                                    <div class="review-author-comment">
                                        ...
                                        <div class="comment-respond form-relative">
                                              <form action="#" method="POST">
                                                  <input type="text" placeholder="" required class="theme-input-style">
    ...
    <!-- back to top -->
    	...
    	<script type="text/javascript">
	    	...
	    	increaseQuantityBtn.addEventListener("click", function() {
	    	    ...
	    	    if (currentValue < ${pc.sanPham.soLuong}) {

                ...
                <div class="col-12">
                    ...
                    <div class="page-title-wrap">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="active"><a>${gear.sanPham.tenSanPham }</a></li>
                        </ul>
                    </div>
                        ...
                        <!-- Start shop slider top side -->
                         <div class="swiper-container product-gallery">
                            <div class="swiper-wrapper">
                            	...
                            	<c:forEach items="${gear.sanPham.hinhAnhSanPhams }" var="hinhAnh">
                    ...
                    <div class="product-details-inner">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-title">
                                <h2><a>${gear.sanPham.tenSanPham }</a></h2>
                            </div>
                            <!-- end of product title -->

                             <div class="product-price">
                             	<h3 class="new-price">${gear.sanPham.giaBanFormatted }</h3>
                             	<c:if test="${gear.sanPham.giamGia > 0 }">
                             		<h5 class="old-price">${gear.sanPham.giaTienFormatted }</h5>
                             	</c:if>
                             </div>

                             <div class="product-description">
                                 <p>Nhãn hàng: ${gear.sanPham.brand.tenHang }</p>
                             </div>
                                ...
                                <ul class="mb-0 list-unstyled">
                                    ...
                                    <li class="available-group group">
                                        ...
                                        <div class="product-available">
                                            <input type="text" value="${gear.sanPham.soLuong }" class="product-quantity-list product-size">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="product-details-btns">
                                <div class="addto-cart-btn">
                                    <div onclick="AddToCart('${base}',${gear.sanPham.id },parseInt(document.getElementById('quantityInput').value))">
    ...
    <!-- back to top -->
    	...
    	<script type="text/javascript">
	    	...
	    	increaseQuantityBtn.addEventListener("click", function() {
	    	    ...
	    	    if (currentValue < ${gear.sanPham.soLuong}) {
